package io.github.hsm7.superheroes.fight.rest;
...
import io.github.hsm7.superheroes.fight.HeroesVillainsWiremockServerResource;
import io.github.hsm7.superheroes.fight.InjectWireMock;
...
import io.github.hsm7.superheroes.fight.Fighters;
import io.github.hsm7.superheroes.fight.client.Hero;
import io.github.hsm7.superheroes.fight.client.Villain;
...
public class FightResourceIT {
    ...
    public void beforeEach() {
        ...
        Serde<AvroFight> serde = Serdes.serdeFrom(new AvroKafkaSerializer<>(), new AvroKafkaDeserializer<>());
        serde.configure(companion.getCommonClientConfig(), false);
        companion.registerSerde(AvroFight.class, serde);
    }
    ...
    public void getFoundFight() {
        var expectedFight = new io.github.hsm7.superheroes.fight.Fight();
        ...
        var fight = get("/api/fights/{id}", getAndVerifyAllFights().get(0).id.toString())
                ...
                .statusCode(OK.getStatusCode())
                .contentType(JSON)
                .extract().as(io.github.hsm7.superheroes.fight.Fight.class);

        Assertions.assertThat(fight)
                .isNotNull()
                .usingRecursiveComparison()
    ...
    public void performFightHeroWins() {
        var fights = companion.consume(AvroFight.class)
        ...
        Assertions.assertThat(fightResult)
                .isNotNull()
                .usingRecursiveComparison()
                .ignoringFields("id", "fightDate")
                .isEqualTo(expectedFight);
    ...
    private List<io.github.hsm7.superheroes.fight.Fight> getAndVerifyAllFights() {
        var expectedFights = List.of(new io.github.hsm7.superheroes.fight.Fight(), new io.github.hsm7.superheroes.fight.Fight(), new io.github.hsm7.superheroes.fight.Fight());
        ...
        var fights = get("/api/fights")
                ...
                .contentType(JSON)
                .extract().body()
                .jsonPath().getList(".", io.github.hsm7.superheroes.fight.Fight.class);
