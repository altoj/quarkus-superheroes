package io.github.hsm7.superheroes.fight.service;
...
import io.github.hsm7.superheroes.fight.client.HeroClient;
import io.github.hsm7.superheroes.fight.client.Villain;
import io.github.hsm7.superheroes.fight.client.VillainClient;
import io.github.hsm7.superheroes.fight.config.FightConfig;
import io.github.hsm7.superheroes.fight.mapping.FightMapper;
...
public class FightService {
    ...
    private final MutinyEmitter<AvroFight> emitter;
    private final FightConfig fightConfig;
    private final FightMapper fightMapper;
    private final Random random = new Random();

    public FightService(HeroClient heroClient, VillainClient villainClient, @Channel("fights") MutinyEmitter<AvroFight> emitter, FightConfig fightConfig, FightMapper fightMapper) {
