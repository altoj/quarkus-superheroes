...
/**
 * Tests for the {@link TeamStats} class. Not a {@link io.quarkus.test.junit.QuarkusTest @QuarkusTest} because the test can simply call the methods with the appropriate input.
 */
class TeamStatsTests {
    private static final AvroFight HERO_WINNER = new AvroFight(
            "1",
            Instant.now(),
            "Chewbacca",
            2,
    ...
    private static final AvroFight VILLAIN_WINNER = new AvroFight(
            "2",
            Instant.now(),
            "Darth Vader",
            2,
