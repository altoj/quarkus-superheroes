...
public class WebSocketsIT {
    ...
    public void beforeEach() {
        // Configure Avro Serde for AvroFight
    ...
    public void testScenarios() throws DeploymentException, IOException {
        ...
        try (
            ...
            companion.produce(AvroFight.class)
                    .fromRecords(sampleFights.stream()
                            .map(fight -> new ProducerRecord<String, AvroFight>("fights", fight))
    ...
    private static List<AvroFight> createSampleFights() {
        return IntStream.range(0, 10)
                .mapToObj(i -> {
                    var heroName = HERO_NAME;
                    var villainName = VILLAIN_NAME;
                    var fight = AvroFight.newBuilder()
